...
class YahooKeyphraseTest < Test::Unit::TestCase
  def setup
    if true
      @host = "localhost"
      @port = 8080
  ...
  def test_extract__10__by_post
    ...
    expected = {
      "1" => {
        ...
        "keyphrase" => {
          "乗用車"=>56,"中山駅間"=>38,"横浜市緑区三保町"=>100,"踏切"=>49,"衝突"=>41,
          "上り列車"=>83,"6日午前0時すぎ"=>24,"十日市場"=>28,"JR横浜線"=>56,
        },
      },
      "2" => {
        "text"      => "ＪＲ宝塚線（福知山線）脱線事故で、業務上過失致死傷容疑で告訴され不起訴処分になったＪＲ西日本の歴代社長３人について",
        "keyphrase" => {
          "脱線事故"=>34,"JR宝塚線"=>31,"告訴"=>33,"福知山線"=>37,"業務上過失致死傷容疑"=>50,
          "不起訴処分"=>46,"歴代社長3人"=>28,"JR西日本"=>100,
        },
      },
      "3" => {
        "text"      => "脳科学者の茂木健一郎氏（４７）が、東京国税局から３億数千万円の申告漏れを指摘されていたことが分かった。",
        "keyphrase" => {
          "東京国税局"=>42,"3億数千万円"=>11,"脳科学者"=>39,"申告漏れ"=>40,"指摘"=>25,
          "茂木健一郎"=>100,
        },
      },
      "4" => {
        ...
        "keyphrase" => {
          "東京都港区"=>38,"個人事務所"=>31,"所属事務所"=>33,"10日"=>6,"朝日出版社刊"=>43,
          "20XXTOKYO"=>8,"篠山紀信"=>100,"青山霊園"=>43,"同区赤坂9丁目"=>40,"警視庁"=>37,
          "家宅捜索"=>45,"写真集"=>21,"女優"=>23,"ロケ"=>28,"ヌード撮影"=>35,
          "自宅"=>21,"疑い"=>27,"女性"=>17,"モデル"=>23,"写真家"=>39,
        },
      },
      "5" => {
        "text"      => "厚生労働省が９日に公表した０８年の国民健康・栄養調査で、男性の喫煙率が３６．８％と調査開始の８６年以降で、過去最低になったことが明らかになった。",
        "keyphrase" => {
          "喫煙率"=>70,"栄養調査"=>73,"国民"=>56,"36.8%"=>15,"厚生労働省"=>100,
          "公表"=>64,"08年"=>15,"9日"=>14,"男性"=>46,"過去"=>45,
          "86年以降"=>42,"調査開始"=>63,
        },
      },
      "6" => {
        ...
        "keyphrase" => {
          "ヤンキース"=>78,"榊原一生"=>60,"最優秀選手"=>52,"今季"=>43,"申請"=>39,
          "シカゴ"=>57,"大リーグ"=>69,"松井秀喜選手"=>68,"契約最終年"=>75,"MVP"=>33,
          "9日"=>9,"日本選手初"=>39,"ワールドシリーズ"=>100,"フリーエージェント"=>71,
        },
      },
      "7" => {
        "text"      => "指定暴力団道仁会の本部事務所について、福岡県公安委員会は１０日、これまでの福岡県久留米市通東町から、約２キロ西にある同市京町の系列の組事務所に移転したと、官報で公示した。",
        "keyphrase" => {
          "移転"=>36,"官報"=>54,"指定暴力団道仁会"=>78,"10日"=>9,"福岡県公安委員会"=>65,
          "福岡県久留米市通東町"=>100,"本部事務所"=>47,"同市京町"=>65,"公示"=>50,"系列"=>38,
          "組事務所"=>39,"約2キロ西"=>27,
        },
      },
      "8" => {
        ...
        "keyphrase" => {
          "カンボジア政府"=>35,"プノンペン"=>100,"10日"=>5,"山本大輔"=>27,"ロイター"=>32,
          "タイ"=>18,"タクシン元首相"=>78,"空軍施設"=>30,"空路到着"=>31,"就任"=>21,
          "経済顧問"=>26,
        },
      },
      "9" => {
        ...
        "keyphrase" => {
          "一部"=>21,"名古屋駅前ロータリー"=>52,"岩下毅撮影"=>47,"10日午後0時23分"=>12,"画像"=>17,
          "10日正午ごろ"=>41,"横転"=>61,"修整"=>44,"コンクリートミキサー車"=>74,"名古屋市中村区名駅4丁目"=>55,
          "名古屋市中村区"=>100,
        },
      },
      "10" => {
        ...
        "keyphrase" => {
          "大阪市西成区"=>100,"逮捕"=>27,"以外放火"=>36,"10日"=>7,"疑い"=>29,
          "大阪市西成区玉出東2丁目"=>57,"自称無職高口善行"=>64,"建造物"=>43,"西成署"=>44,"容疑者"=>35,
          "ぐち"=>33,"発表"=>20,"段ボール"=>44,
        },
      },
    }
